...
from models.SimpleCNNClassification import SimpleCNNClassification  # Adjust the import based on your CNN model
...
wandb.init(
    ...
    notes="auc calc added, criterion fixed, indentation error fixed test run",
)
