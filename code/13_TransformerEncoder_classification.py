...
from models.TransformerEncoderModelClassification import TransformerEncoderModelClassification
...
# Create the model
model = TransformerEncoderModelClassification(input_size, patch_size, num_layers, num_heads, dim_feedforward, output_size=5).to(device)
