...
from models.TransformerEncoderModel2 import TransformerEncoderModel
from models.TransformerEncoderModel2 import CombinedModel
...
# Optimizer and loss function
optimizer = torch.optim.Adam(model.parameters(), lr=learning_rate, weight_decay=0.001)  # Added weight decay for regularization
criterion = nn.L1Loss()
