...
# Create the model
model = TrasnformerEncoderCnnModel(input_size, patch_size, num_layers, num_heads, dim_feedforward, output_size=1).to(device)
...
model_name = "14_Transformer_HR_"  # Your specific model name prefix
