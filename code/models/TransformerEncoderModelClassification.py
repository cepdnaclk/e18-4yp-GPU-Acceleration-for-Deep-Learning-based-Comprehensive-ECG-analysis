...
class TransformerEncoderModelClassification(nn.Module):
    def __init__(self, input_size, patch_size, num_layers, num_heads, dim_feedforward, output_size=5):
        super(TransformerEncoderModelClassification, self).__init__()
