...
wandb.init(
    ...
    notes="using driven-night-43 A:HR >>>B:HR",
)
...
model = torch.load("saved_models/22_Inception1D_regression.py_hr_20240620_074721_driven-night-43", map_location="cuda:0")

# Freeze the first 42 layers of the model # 42 is based on the manual inspection of the model architecture
count=0
